...
def main() -> None:
    ...
    print(f"  Linear Regression Train MAE: {metrics['linear_mae']:.3f}")
    print(f"  Linear Regression Train R2:  {metrics['linear_r2']:.3f}")
    print(f"  Linear Regression Test MAE:  {metrics['linear_test_mae']:.3f}")
    print(f"  Linear Regression Test R2:   {metrics['linear_test_r2']:.3f}")
    print()
    print(f"  Random Forest Train MAE:     {metrics['forest_mae']:.3f}")
    print(f"  Random Forest Train R2:      {metrics['forest_r2']:.3f}")
